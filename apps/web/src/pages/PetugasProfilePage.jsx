                ...
                <div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden mb-6">
                    <div className="border-b border-slate-100 px-6 py-4 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <span className="inline-flex items-center gap-1 rounded-full bg-blue-50 px-2 py-0.5 text-xs font-medium text-blue-700 mt-1">
                                <span className="material-symbols-outlined text-xs">badge</span>Petugas
                            </span>
                        </div>
                    </div>
...
export default PetugasProfilePage;
